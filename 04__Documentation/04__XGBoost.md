...
\end{align*}
  ...
  Note that the objective function denoted with $\mathcal{L}(\phi)$ as two terms, with the first $\sum_i l(\hat{y}_i, y_i)$ being the __loss function__ and the second term being the __regularization__.
